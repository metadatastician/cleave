...
Developers working *on* `Cleave`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Cleave.git
cd Cleave
...
* Bugs in `Cleave`: file at `hyperpolymath/Cleave/issues`.
