...
cleanup() {
    echo "Received shutdown signal — stopping cleave..."
...
# Examples:
#   exec /app/cleave
#   exec /app/release/bin/cleave start
#   exec /app/cleave serve --host "${APP_HOST}" --port "${APP_PORT}"
