...
#
# Cleave — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: cleave-release)
...
CT_KEY_ID="${CT_KEY_ID:-cleave-release}"
...
echo "=== Cleave Cerro Torre Build Pipeline ==="
